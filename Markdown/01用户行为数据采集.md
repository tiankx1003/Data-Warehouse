...
# 分发
xsync share/hadoop/common/hadoop-lzo-0.4.20.jar
vim core-site.xml
...
# hadoop102节点执行程序
java -classpath log-collector-1.0-SNAPSHOT-jar-with-dependencies.jar com.tian.appclient.AppMain  >/opt/module/datas/test.log
...
netstat -tunlp|grep [Port]|查看端口占用
...
2. Kafka机器数量为$2*(峰值生产速度*副本数/100)+1$
3. Kafka日志保存时间为7天
...
7. 副本数设置，一般我我们设置成2个或者3个，很多企业设置为2个
